package com.view.components
{
	...
	public class VideoRecord extends Video 
	{
		...
		public function startRecording(value:String="test"){stream.attachCamera(yourCam);stream.attachAudio(yourMic);stream.client = this;stream.publish(value,_recordedTime==0?"record":"append");startTrackProgress(true);}
		...
		public function resetRecording(){trace("resetting");_recordedTime = 0;stream.publish("null");startTrackProgress(false)}

package com.view.components
{
	...
	public class VideoRecord extends Video 
	{
		...
		public function startRecording(value:String="test"){this.attachCamera(yourCam);stream.attachCamera(yourCam);stream.attachAudio(yourMic);stream.client = this;stream.publish(value,_recordedTime==0?"record":"append");startTrackProgress(true);}
		...
		public function previewRecording( value:String="test" ){this.attachNetStream(stream);stream.play(value);}

		public function pauseRecording(){_recordedTime = mediaPosition; stream.close();startTrackProgress(false)}
		public function resetRecording(){_recordedTime = 0;stream.publish("null");startTrackProgress(false)}
